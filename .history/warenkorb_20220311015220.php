                            ...
                            <div class="w-full">
                                ...
                                <span class="flex flex-col items-center justify-between w-full gap-3 sm:flex-row">
                                    <form action="" method="POST">
                                        Menge: <input type="number" class="px-3 py-2 border-2 border-green-500" name="count" value="<?= $anzahl ?>">
                                        <input type="submit" class="px-3 py-2 border-2 border-green-500" name="<?= $sorte ?>" value="Ändern">
                                    </form>
                                    <form action="" method="POST">
                                        <input type="submit" class="px-3 py-2 border-2 border-red-500" name="<?= $sorte ?>" value="Entfernen">
                                    </form>
                    ...
                    <div class="flex flex-col items-center gap-3 px-3 py-3 my-3 bg-gray-200">
                        ...
                        <div class="flex items-center justify-between w-full">
                            <div class="flex gap-4">
                                ...
                                <form action="" method="POST">
                                    <input class="px-3 py-2 text-white bg-green-500 border-2 border-honey" type="submit" name="clear" value="Bestellen">
                                </form>
                            </div>
                            <div class="flex items-center justify-end grow">
                                <?php
