...
class Komponente
{
    ...
    static function input($type = "text", $placeholder = '', $name = '', $required = 'true')
    {
        $classes = "grow text-left px-3 py-2 border-2 hover:bg-gray-200 active:scale-95 hover:scale-105 border-orange-400";
