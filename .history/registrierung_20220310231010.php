...
<head>
    ...
    <title>Honig4U Registrierung</title>
        ...
        <section class="bg-white max-w-lg mx-auto shadow-xl p-4">
            ...
            <form class="flex flex-col gap-4 py-4" method="POST" action="">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <input class="px-2 py-2 grow rounded ring-2 ring-honey" type="text" required name="nachname" placeholder="Nachname">
                </div>
                ...
                <input type="submit" class="px-2 py-2 rounded ring-2 font-semibold text-xl text-honeygreen ring-honey" name="register" value="Registrieren">
            </form>
        </section>
    </main>
</body>
