        ...
        <section class="bg-white w-full mx-auto rounded-md shadow-xl p-4">
            <div class="flex flex-col py-8 border-4 mt-4 px-8">
                ...
                <?php else : ?>
                    ...
                    <?php endforeach; ?>
                    <div class="flex flex-col items-center gap-3 my-3 bg-gray-200 py-3 px-3">
                        <div class="flex flex-col w-full gap-2 mb-3 items-stretch">
                        ...
                        <div class="flex items-center justify-between w-full">
                            <div class="flex gap-4">
                                <form action="" method="POST">
                                    <input class="px-3 py-2 bg-red-500 text-white border-honey border-2" type="submit" name="clear" value="Warenkorb löschen">
                                </form>
                                <form action="" method="POST">
                                    <input class="px-3 py-2 bg-green-500 text-white border-honey border-2" type="submit" name="clear" value="Bestellen">
                                </form>
                            </div>
                            <div class="flex items-center grow justify-end">
                                <?php
                                ...
                                <span class="flex gap-2 items-center">
                                    ...
                                    <p class="text-xl bg-white px-3 py-2">CHF <?= sprintf('%.2f', $gesamt) ?></p>
                                </span>
